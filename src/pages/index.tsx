...
const IndexPage : React.FC<Props> = ({ className, data }) => {
	return (
		<article className={ `index-page ${ className }` }>
			...
			<NotePad>Compatible with React v19.2.0 and above. For earlier React versions, please use <Anchor to="https://react-observable-context.js.org">React Observablele Context</Anchor>.</NotePad>
